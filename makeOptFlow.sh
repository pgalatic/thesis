...
flowCommandLine="bash core/run-deepflow.sh"
...
if [ ! -f ./core/consistencyChecker/consistencyChecker ]; then
  if [ ! -f ./core/consistencyChecker/Makefile ]; then
...
while [ 1 ]; do
  ...
  if [ -a $file2 ] && [ -a $file1 ]; then
    ...
    ./core/consistencyChecker/consistencyChecker "${folderName}/backward_${i}_${j}.flo" "${folderName}/forward_${j}_${i}.flo" "${folderName}/reliable_${i}_${j}.pgm" "$file1"
    ./core/consistencyChecker/consistencyChecker "${folderName}/forward_${j}_${i}.flo" "${folderName}/backward_${i}_${j}.flo" "${folderName}/reliable_${j}_${i}.pgm" "$file2"
